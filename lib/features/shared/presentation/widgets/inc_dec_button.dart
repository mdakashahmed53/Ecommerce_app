...
class IncDecButton extends StatefulWidget {
  const IncDecButton({super.key, required this.initialValue, required this.onChange, required this.maxValue, required this.minValue});
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text("$_count", style: TextStyle(fontSize: 18, fontWeight: .w600),),
